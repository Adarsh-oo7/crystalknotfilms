...
<div className="relative flex min-h-screen items-center justify-center bg-[#1a1a1a] text-white p-4 md:p-8 overflow-x-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <div className="grid grid-cols-2 grid-rows-2 gap-4 opacity-5">
          {["OUR", "FILMS", "OUR", "FILMS"].map((word, i) => (
            <span key={i} className="text-9xl font-extrabold text-gray-600 uppercase tracking-widest">
              {word}
            </span>
          ))}
        </div>
