    ...
    const testimonials = [
        {
            ...
            rightContent: {
                ...
                text: "Crystal Knot Films were fantastic! Will definitely use them again. They were fast and the quality of work was excellent. They even took care to fix a few mistakes I made with my shoot. Highly recommend.",
                name: "Palm Tree",
            }
        },
        {
            ...
            rightContent: {
                ...
                name: "Aesthete Films & Photography",
            }
        },
        {
            leftContent: {
    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-[#1E1E1E] p-4 md:p-8">
            <div className="w-full max-w-6xl space-y-8">
                <h2 className="text-center text-[26px] sm:text-[28px] md:text-[30px] lg:text-[34px] xl:text-[40px] text-white tracking-widest"
