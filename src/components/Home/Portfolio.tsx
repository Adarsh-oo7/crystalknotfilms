...
export default function PortfolioSection() {
  ...
  return (
    <section id="Portfolio" className="w-full py-20   bg-black">
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-2">
            <h2 className="text-3xl font-medium tracking-tighter sm:text-5xl text-white pb-10" style={{ fontFamily: "Cinzel" }}>PORTFOLIO</h2>
            <p className="max-w-[800px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed" style={{ fontFamily: "Quicksand, serif" }}>
